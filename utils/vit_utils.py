...
def load_state_dict(checkpoint_path, use_ema=False):
    if checkpoint_path and os.path.isfile(checkpoint_path):
        ...
        print.info("Loaded {} from checkpoint '{}'".format(state_dict_key, checkpoint_path))
        return state_dict
    else:
...
def load_pretrained(model, cfg=None, num_classes=1000, in_chans=3, filter_fn=None, img_size=224, num_frames=8, num_patches=196, attention_type='divided_space_time', pretrained_model="", strict=True):
    ...
    if in_chans == 1:
        ...
        print.info('Converting first conv (%s) pretrained weights from 3 to 1 channel' % conv1_name)
        ...
        O, I, J, K = conv1_weight.shape
        if I != 3:
            print.warning('Deleting first conv (%s) from pretrained weights.' % conv1_name)
