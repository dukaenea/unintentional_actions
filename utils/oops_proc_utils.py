...
def filter_unlabeled():
    ...
    train_video_dir = (
        "/BS/unintentional_actions/nobackup/oops/oops_dataset/oops_video/train"
    )
    val_video_dir = (
        "/BS/unintentional_actions/nobackup/oops/oops_dataset/oops_video/val"
    )
    base_split_path = "/BS/unintentional_actions/work/metadata/oops/splits"
