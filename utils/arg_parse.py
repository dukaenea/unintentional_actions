...
#######################################################################################
### DATA
parser.add_argument('--dataset', default='kt',
...
parser.add_argument('--one_plus2_model', default='',
...
#######################################################################################
### KINETICS
parser.add_argument('--feat_type', default='sp+kin',
                    help='preextracted features:'
                         ...
                         'video       -- pure videos')
parser.add_argument('--spatial_size', default=112, type=int,
                    help='spatial crop size for input video frames')
parser.add_argument('--video_fps', default=25, type=int,
                    help='unify fps for all videos')
parser.add_argument('--spat_crop', default='central',
                    help='if to perform central crop or not for augmentation')
parser.add_argument('--spat_scale', default=False, type=bool)
parser.add_argument('--h_flip', default=False, type=bool,
                    help='if to perform horizontal flip of the frames for augmentation')
parser.add_argument('--inverse_colors', default=False,
                    help='inverse frames colors for augmentation')
...
parser.add_argument('--fails_path', default='/BS/unintentional_actions/nobackup/oops/oops_dataset/oops_video', type=str)
...
parser.add_argument('--kinetics_path', default='/BS/unintentional_actions/nobackup/kinetics400/data', type=str)
parser.add_argument('--frames_per_clip', default=16, type=int)
parser.add_argument('--clip_interval_factor', default=1, type=int)
parser.add_argument('--dataset_path', default='/BS/unintentional_actions/nobackup/oops', type=str)
...
parser.add_argument('--transformations_list', default=['normal', 'speedx2', 'speedx3', 'speedx4', 'shuffle', 'warp', 'random_point_speedup', 'double_flip'], nargs='+')

#######################################################################################
### FEATURE_AUGMENTATION

parser.add_argument('--spatial_augmentation', default=False, type=bool,
                    help='augment spatially features when training classifier')
parser.add_argument('--temporal_augmentation', default=False, type=bool,
                    help='augment temporally features when training classifier')
parser.add_argument('--two_stream', default=False, type=bool,
                    help='augment features when training classifier')
parser.add_argument('--add_noise', default=False, type=bool,
                    help='augment features by adding gaussian noise when '
                         'training classifier')
parser.add_argument('--nn_lerp', default=False, type=bool,
                    help='augment features by interpolating between nearest'
                         'neighbours when training classifier')
parser.add_argument('--linear_delta', default=False, type=bool,
                    help='augment features by calculating difference of nearest'
                         'neighbours when training classifier')
parser.add_argument('--spat_augms', default='', type=str,
                    help='list of spatial augmentations')
parser.add_argument('--temp_augms', default='', type=str,
                    help='list of temporal augmentations')

parser.add_argument('--tsn_encoder', default='', type=str,
                    help='use tsn encoder before feeding to classifier')
parser.add_argument('--use_dtn', default=False, type=bool,
                    help='use Detail Transfer Network to synthesize new data')
...
parser.add_argument('--test', default=False, type=bool,
                    help='to test on the test splits')
...
parser.add_argument('--viz_meta', default=True, type=bool,
