...
from utils import my_video_opt
from utils.my_video_opt import VideoMetaData
...
def read_video(
    ...
    if get_video_backend() != "pyav":
        return my_video_opt._read_video(filename, start_pts, end_pts, pts_unit)
...
def read_video_timestamps(
    ...
    if get_video_backend() != "pyav":
        return my_video_opt._read_video_timestamps(filename, pts_unit)
