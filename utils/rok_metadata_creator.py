...
def create_rok_mdata(mode):
    materials = {
        # 'rareact': '/BS/unintentional_actions/work/metadata/rareact/splits/%s.csv' % mode,
        # 'oops': '/BS/unintentional_actions/work/metadata/oops/splits/%s_all.csv' % mode,
        "kinetics": "/BS/unintentional_actions/work/metadata/kinetics/splits/%s_rep_lrn.csv"
        % mode
    }

    rok_mdata_path = (
        "/BS/unintentional_actions/work/metadata/rok/data_splits/%s_rep_lrn_kin.csv"
        % mode
    )
    rok_mdata = []
