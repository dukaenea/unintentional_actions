...
python main.py /BS/unintentional_actions/work/unintentional_actions/configs/ablations/transform_type_ablations/transformation_type_ablation_speed_x3_stage2.yml