...
class OopsR21DFeatDatast(Dataset):
    def __init__(self, mode):
        ...
        self.feat_path = os.path.join("../resources/data/features/r21d_features", mode)
    ...
    def __getitem__(self, idx):
        ...
        out = {
            "features": torch.from_numpy(npy_file.item().get("feature")),
            "labels": npy_file.item().get("label"),
        }
        return out
