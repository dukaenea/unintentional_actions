...
from crime_detection_i3d.train import train
import torch
...
if __name__ == '__main__':
    ...
    train_nloader = DataLoader(Dataset('train', test_mode=False, is_normal=True),
                               batch_size=opt.batch_size, shuffle=True,
                               num_workers=0, pin_memory=False, drop_last=True)
    train_aloader = DataLoader(Dataset('train', test_mode=False, is_normal=False),
                               batch_size=opt.batch_size, shuffle=True,
                               num_workers=0, pin_memory=False, drop_last=True)

    test_loader = DataLoader(Dataset('val', test_mode=True),
    ...
    # model = Model(2048, opt.batch_size)
    ...
    train(model=model,
          train_normal_loader=train_nloader,
          train_abnormal_loader=train_aloader,
