...
class ConvVAE(nn.Module):
    def __init__(self, in_channels):
        ...
        self.convt2 = nn.ConvTranspose2d(
            256, 512, kernel_size=(5, 5), stride=1, padding=2
        )
        # nn.Sigmoid(),
        self.convt3 = nn.ConvTranspose2d(
            512, in_channels, kernel_size=(11, 11), stride=4
        )
        # )
...
def create_model(
    in_channels, lr, optim="adam", weight_decay=0, momentum=0, pretrained=False
):
