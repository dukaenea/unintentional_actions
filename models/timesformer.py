...
from utils.vit_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from utils.vit_utils import DropPath, to_2tuple, trunc_normal_
from utils.vit_utils import load_pretrained
...
class TimeSformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, num_classes=3, num_frames=16, attention_type='divided_space_time',  pretrained_model='', **kwargs):
