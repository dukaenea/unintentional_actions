...
if __name__== "__main__":
    ...
    ExtremaAndPersistence = FilterExtremaByPersistence(ExtremaAndPersistence, 1) #try commenting out this line
    ...
    Visualize(InputData, ExtremaAndPersistence, FigAx, "extrema fat", SaveFilename="Persistence1D_Example2.png")
    PrintExtrema(InputData, ExtremaAndPersistence)
